=== Shashin permalinks ===
Contributors: Sébastien "SLiX" Liénard
...
This plugin add permalinks support for Shashin plugin galleries (default keywords: "album" and "page")
